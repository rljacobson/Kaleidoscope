...
#include "kaleidoscope/driver/keyscanner/MCP23018KeyScannerDescription.h"
...
struct ErgoDoxMCP23018KeyScannerDescription : kaleidoscope::driver::keyscanner::MCP23018KeyScannerDescription {
