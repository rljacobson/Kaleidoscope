...
#include "kaleidoscope/driver/keyscanner/MCP23018KeyScanner.h"
...
class ErgoDoxKeyScanner : public kaleidoscope::driver::BaseKeyScanner<_KeyScannerDescription> {
 public:
  ...
  typedef typename kaleidoscope::driver::keyscanner::MCP23018KeyScanner<typename _KeyScannerDescription::ExpanderKeyScannerDescription> ExpanderKeyScanner;
